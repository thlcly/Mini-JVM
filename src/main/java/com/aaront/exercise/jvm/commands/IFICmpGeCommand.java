 ...
 * @since 2017/8/22
 */
public class IFICmpGeCommand extends TwoOperandCommand{
    public IFICmpGeCommand(ClassFile clzFile, String opCode, int operand1, int operand2) {
