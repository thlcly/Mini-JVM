...
public enum Command {
    ...
    IF_ICMP_GT("A3", "if_icmp_gt"),
    IF_ICMP_LE("A4", "if_icmp_le"),
    GOTO("A7", "goto"),
    RETURN("B1", "return"),
    IRETURN("AC", "ireturn"),
    FRETURN("AE", "freturn"),
    ICONST_M1("02", "iconst_m1"),
    ICONST_0("03", "iconst_0"),
    ICONST_1("04", "iconst_1"),
    ICONST_2("05", "iconst_2"),
    ICONST_3("06", "iconst_3"),
    ICONST_4("07", "iconst_4"),
    ICONST_5("08", "iconst_5"),
    ISTORE_0("3B", "istore_0"),
    ISTORE_1("3C", "istore_1"),
    ISTORE_2("3D", "istore_2"),
    ISTORE_3("3E", "istore_3"),
    DUP("59", "dup"),
    IADD("60", "iadd"),
    IINC("84", "iinc"),
    LDC("12", "ldc"),
